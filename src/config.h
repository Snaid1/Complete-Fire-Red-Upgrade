...
/*===== OW Palette Options =====*/
#define TREE_DISGUISE_PAL_ID 0x1182 //The NPC palette id of the tree disguise movement permission.
#define ROCK_DISGUISE_PAL_ID 0x1181 //The NPC palette id of the mountain disguise movement permission.
#define WEIRD_DISGUISE_PAL_ID 0x1180 //The NPC palette id of the weird disguise movement permission.
